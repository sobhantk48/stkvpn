...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/STKVPN/V2RAY-STK"
    const val APP_API_URL = "https://api.github.com/repos/YOUR_USERNAME/V2RAY-STK/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/STKVPN/V2RAY-STK/main/CR.md"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly85LjIzNDQ1Ni54eXovYWJjLmh0bWw="
    const val TG_CHANNEL_URL = "https://t.me/YOUR_CHANNEL"
    ...
    const val RAY_NG_CHANNEL_NAME = "V2RAY STK Service"
